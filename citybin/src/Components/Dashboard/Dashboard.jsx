    ...
    <div className="flex-1 flex flex-col ml-64">
      ...
      <div className="flex-1 p-4 bg-gray-100">
        <div className="grid grid-cols-4 gap-4 mb-4">
          <StatusBox title="Total Bins" value="128" />
          <StatusBox title="Active Bins" value="103" />
          <StatusBox title="Full Bins" value="16" />
          <StatusBox title="Maintenance Issues" value="5" />
        </div>
        <div className="grid grid-cols-3 gap-4">
          <div 
            ...
            onClick={() => handleNavigation('Waste Collection Trends')}
          >
            <div className="h-64">
          ...
          <div 
            ...
            onClick={() => handleNavigation('Sensor & Connectivity Status')}
          >
...
function StatusBox({ title, value }) {
  return (
    <div className="bg-white rounded-lg p-4 text-center border border-gray-200 hover:shadow-lg transition-all duration-200 hover:border-green-500 cursor-pointer">
